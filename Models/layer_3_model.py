...
class Layer_3(Document):
    ...
    layer1 = ReferenceField(Layer_1,db_field='key',required=True,reverse_delete_rule=2)
    layer2 = ReferenceField(Layer_2,db_field='key',required=True,reverse_delete_rule=2)
